!(function () {
  ...
  var o = function (e) {
      ...
      return i.reduceRight(
        ...
        function (e) {
          ...
          'string' == typeof s &&
            ((t = a.replace(/^\/|\/$/g, '')), (i = (r = s.replace(/^\//, '')) ? t + '/' + r : t)),
            'string' == typeof i &&
              (-1 !== n.indexOf('?') && (i = i.replace('?', '&')),
              (i = i.replace(/^\//, '')),
              (o = n + i)),
            delete (u = c(
              {
            ...
            f && ((l = JSON.stringify(f)), (u['Content-Type'] = 'application/json'));
          var d = {
              code: 'fetch_error',
    ...
    const c = {
      ...
      i = t => {
        ...
        n.setAttribute('id', t.error_id),
          t.idref
            ? n.insertAdjacentHTML('beforeend', `<a href="#${t.idref}">${t.message}</a>`)
      ...
      .then(r => {
        ...
        return (
          ...
          ['invalid', 'unaccepted', 'spam', 'aborted'].includes(a)
            ? n(e, a, c)
            : ['sent', 'failed'].includes(a) && n(e, `mail${a}`, c),
          n(e, 'submit', c),
          r
        );
      })
  ...
  var f = function (e, t) {
      var n = function (n) {
        ...
        a &&
          e
            .querySelectorAll('input[name="_wpcf7_captcha_challenge_'.concat(n, '"]'))
            .forEach(function (e) {
              e.value = a[1];
            });
      };
      ...
      (function (e) {
        e.querySelectorAll('.wpcf7-exclusive-checkbox').forEach(function (t) {
          t.addEventListener('change', function (t) {
            ...
            e.querySelectorAll('input[type="checkbox"][name="'.concat(n, '"]')).forEach(function (
              e,
            ) {
