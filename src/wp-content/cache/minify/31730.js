              ...
              var n = (function t(r, e) {
                ...
                if (n === u) {
                  if (((e.delegate = null), 'throw' === e.method)) {
                    if (
                      r.iterator.return &&
                      ((e.method = 'return'), (e.arg = u), t(r, e), 'throw' === e.method)
                    )
                      return v;
                    (e.method = 'throw'),
                ...
                if ('throw' === n.type)
                  return (e.method = 'throw'), (e.arg = n.arg), (e.delegate = null), v;
                n = n.arg;
                if (!n)
                  return (
                    (e.method = 'throw'),
      ...
      function t() {
        return new c(function (t, r) {
          !(function r(t, e, n, o) {
            ...
            if ('throw' !== t.type) {
              var i = t.arg;
              return (e = i.value) && 'object' == typeof e && h.call(e, '__await')
  ...
  function O(r) {
    if (r) {
      ...
      if (!isNaN(r.length)) {
        var e = -1,
          t = function t() {
            for (; ++e < r.length; ) if (h.call(r, e)) return (t.value = r[e]), (t.done = !1), t;
  ...
  return (
    ...
    (j.prototype = {
      ...
      abrupt: function (t, r) {
        ...
        var i = (o =
          o && ('break' === t || 'continue' === t) && o.tryLoc <= r && r <= o.finallyLoc ? null : o)
          ? o.completion
          : {};
        return (
          (i.type = t),
        ...
        function (t, n, r) {
          ...
          (t.exports = function (t, n, r, e) {
            ...
            'function' == typeof r &&
              ...
              t !== u
                ? (o ? !c && t[n] && (i = !0) : delete t[n], i ? (t[n] = r) : f(t, n, r))
                : i
                ? (t[n] = r)
                : s(n, r);
            ...
            r = function (u) {
              return function (t, n, r) {
                var e,
                  ...
                  c = s(r, i);
                if (u && n != n) {
                  for (; c < i; ) if ((e = o[c++]) != e) return !0;
                } else for (; c < i; c++) if ((u || c in o) && o[c] === n) return u || c || 0;
                return !u && -1;
              };
            };
          t.exports = {
            ...
            ('__proto__' in {}
              ? (function () {
                  var r,
                    ...
                    t = {};
                  try {
                    (r = Object.getOwnPropertyDescriptor(Object.prototype, '__proto__').set).call(
                      t,
                      [],
                    ),
          ...
          (a[v] = !0),
            (t.exports =
              ...
              function (t, n) {
                ...
                return (
                  null !== t
                    ? ((e[l] = c(t)), (r = new e()), (e[l] = null), (r[v] = t))
                    : (r = y()),
                  n === S ? r : u(r, n)
                );
              });
          ...
          t.exports = function (t) {
            return (
              (i(f, t) && (u || 'string' == typeof f[t])) ||
                (u && i(a, t) ? (f[t] = a[t]) : (f[t] = s('Symbol.' + t))),
              f[t]
            );
          };
        },
          ...
          t.exports = e
            ...
            : function (t) {
                ...
                return t === S
                  ...
                  : c
                  ? o(n)
                  : 'Object' == (t = o(n)) && 'function' == typeof n.callee
                  ? 'Arguments'
                  : t;
              };
        },
        ...
        function (t, n, r) {
          ...
          (y && h) ||
            ...
            g
              ...
              : b && !l
              ? ((b = (l = new b()).port2), (l.port1.onmessage = i), (c = a(b.postMessage, b, 1)))
              : u.addEventListener &&
                ...
                'file:' !== v.protocol &&
                !f(r)
              ? ((c = r), u.addEventListener('message', i, !1))
              : (c =
                  w in p('script')
                    ? function (t) {
